...
contract Item is StandardToken {
  ...
  // Internal exchange method to fulfill trades only within the Trade.sol contract.
  // This makes trading easier for users removing the need for them to "send" tokens to the trade
  // contract prior to trading.
